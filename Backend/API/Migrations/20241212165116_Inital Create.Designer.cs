...
namespace GPS.API.Migrations
{
    ...
    [Migration("20241212165116_Inital Create")]
            ...
            modelBuilder.Entity("GPS.API.Data.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Adi",
                            LastName = "Gosto",
                            PasswordHash = new byte[] { 52, 29, 148, 219, 1, 113, 61, 172, 148, 144, 72, 23, 252, 11, 127, 156, 164, 213, 251, 84, 214, 124, 78, 58, 14, 253, 150, 185, 153, 129, 106, 207, 57, 17, 57, 251, 54, 35, 219, 232, 157, 125, 120, 9, 139, 92, 3, 187, 142, 84, 194, 128, 148, 248, 15, 233, 243, 69, 157, 78, 221, 72, 241, 25 },
                            PasswordSalt = new byte[] { 203, 23, 238, 255, 154, 248, 56, 34, 241, 26, 104, 9, 119, 40, 60, 162, 166, 56, 170, 254, 87, 31, 94, 189, 223, 134, 0, 115, 78, 224, 169, 55, 128, 32, 173, 204, 31, 115, 252, 152, 144, 159, 207, 145, 158, 12, 209, 97, 32, 235, 50, 63, 5, 225, 61, 3, 107, 179, 250, 80, 160, 23, 203, 201, 49, 123, 99, 108, 121, 158, 18, 1, 29, 78, 29, 15, 139, 201, 21, 118, 243, 104, 211, 61, 147, 133, 240, 159, 90, 139, 181, 233, 96, 211, 8, 217, 83, 4, 208, 78, 161, 189, 119, 65, 156, 93, 235, 28, 228, 235, 101, 186, 21, 135, 62, 130, 80, 252, 167, 134, 77, 149, 72, 23, 155, 49, 250, 231 },
                            TenantId = "mostar",
