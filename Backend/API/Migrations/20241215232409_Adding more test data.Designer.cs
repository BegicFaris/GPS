...
namespace GPS.API.Migrations
{
    ...
    [Migration("20241215232409_Adding more test data")]
    partial class Addingmoretestdata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPS.API.Data.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Adi",
                            LastName = "Gosto",
                            PasswordHash = new byte[] { 126, 217, 45, 94, 120, 182, 82, 213, 168, 61, 190, 9, 205, 25, 27, 136, 120, 107, 3, 179, 224, 41, 71, 194, 9, 117, 149, 151, 204, 65, 249, 76, 193, 5, 185, 8, 31, 53, 89, 178, 58, 189, 244, 189, 79, 255, 133, 65, 32, 219, 247, 51, 241, 130, 91, 128, 219, 250, 141, 50, 218, 226, 236, 216 },
                            PasswordSalt = new byte[] { 55, 41, 242, 34, 155, 219, 174, 69, 201, 125, 238, 206, 2, 93, 101, 80, 198, 130, 227, 254, 32, 145, 243, 126, 247, 46, 38, 197, 157, 242, 88, 201, 200, 147, 109, 121, 107, 112, 105, 79, 54, 162, 218, 33, 224, 15, 224, 131, 216, 207, 111, 123, 126, 213, 20, 205, 127, 35, 113, 183, 253, 14, 90, 74, 166, 71, 98, 121, 85, 23, 244, 92, 154, 192, 181, 75, 96, 34, 42, 109, 120, 185, 206, 93, 130, 177, 90, 58, 162, 40, 0, 86, 67, 82, 112, 40, 171, 135, 179, 20, 180, 44, 68, 221, 138, 90, 114, 241, 211, 190, 223, 176, 73, 166, 2, 76, 57, 236, 191, 27, 149, 86, 67, 38, 31, 104, 54, 22 },
                            TenantId = "mostar",
