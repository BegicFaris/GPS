...
namespace GPS.API.Interfaces
{
    ...
    {
        Task<IEnumerable<Notification>> GetAllNotificationsAsync(CancellationToken cancellationToken, bool includeDeleted=false);
        ...
        Task<PagedResult<Notification>> GetNotificationsAsync(int page, int pageSize, CancellationToken cancellationToken, bool includeDeleted = false);
